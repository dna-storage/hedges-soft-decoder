...
do
	...
	do
	    ...
	    upper_index=${upper_index_list[$indexId]}
            out_file="reduce_fix_bonito_hedges_strand${real_strandId}_window--${window_size}_mod--${mod}_${lower_index}-${upper_index}.fastq"
            err_file="reduce_fix_bonito_hedges_strand${real_strandId}_window--${window_size}_mod--${mod}_${lower_index}-${upper_index}.err"
            echo "--------------------------------------------------------------"
